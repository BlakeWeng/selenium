...
class myfox():
    '''目的：不需要每次都重新打开浏览器'''
    def __init__(self):
        self.file=r'D:\python\WebScrapingWithPython\python\第九章第十章\selenium不间断工作\file\params.data'
            # self.file这个文件是保存session_id以及server_url的
        self.gecko=r'D:\python\WebScrapingWithPython\python\第九章第十章\geckodriver.exe'
